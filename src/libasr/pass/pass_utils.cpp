        ...
        ASR::expr_t* create_array_ref(ASR::expr_t* arr_expr,
            ...
            if (ASR::is_a<ASR::StructInstanceMember_t>(*arr_expr) && 
                ASRUtils::type_get_past_allocatable(
                    ASRUtils::symbol_type(ASR::down_cast<ASR::StructInstanceMember_t>(arr_expr)->m_m))->type == ASR::ttypeType::Array){ 
            ...
            while(ASR::is_a<ASR::StructInstanceMember_t>(*arr_expr) && !array_ref_container_node ){
                ...
                if(ASRUtils::type_get_past_allocatable(ASRUtils::expr_type(tmp->m_v))->type == ASR::ttypeType::Array){
                    arr_expr = tmp->m_v;
                    array_ref_container_node = &(tmp->m_v); 
                } else if (ASRUtils::type_get_past_allocatable(ASRUtils::symbol_type(tmp->m_m))->type == ASR::ttypeType::Array && check_m_m){
